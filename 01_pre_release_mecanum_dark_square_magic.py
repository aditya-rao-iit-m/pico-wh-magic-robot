...
def webpage(random_value, state):
    html = """
        ...
        <body>
          ...
          <div class="main-grid">
            <div></div>
            <button class="button lavender rotate-text" ontouchstart="sendCommand('strafe_left')" ontouchend="sendCommand('stop')">←<br>STRAFE LEFT</button>
            <div></div>
            ...
            <div></div>
            <button class="button lavender rotate-text" ontouchstart="sendCommand('strafe_right')" ontouchend="sendCommand('stop')">→<br>STRAFE RIGHT</button>
            <div></div>
          </div>

          <div class="diagonal-grid">
            <button class="button green rotate-text" ontouchstart="sendCommand('back_left')" ontouchend="sendCommand('stop')">BACK<br>LEFT<br>DIAGONAL<br>↙</button>
            <button class="button blue rotate-text" ontouchstart="sendCommand('left')" ontouchend="sendCommand('stop')">↺<br>SPIN LEFT</button>
            <button class="button green rotate-text" ontouchstart="sendCommand('front_left')" ontouchend="sendCommand('stop')">↖<br>FRONT<br>LEFT<br>DIAGONAL</button>

            <button class="button green rotate-text" ontouchstart="sendCommand('back_right')" ontouchend="sendCommand('stop')">BACK<br>RIGHT<br>DIAGONAL<br>↘</button>
            <button class="button blue rotate-text" ontouchstart="sendCommand('right')" ontouchend="sendCommand('stop')">↻<br>SPIN RIGHT</button>
            <button class="button green rotate-text" ontouchstart="sendCommand('front_right')" ontouchend="sendCommand('stop')">↗<br>FRONT<br>RIGHT<br>DIAGONAL</button>
          </div>
